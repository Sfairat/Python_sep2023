    ...
    if (withdraw_sum % 50 == 0) and (card.balance < 5_000_000):
        if withdraw_sum > card.balance:
            ...
            if 30 < (withdraw_sum / 100) * 1.5 < 600:
                ...
                print(f"Снятие денежных средств прошло успешно. Комиссия за снятие наличных 1.5%. Баланс {card.balance}.")
                ...
                print(f"Снятие денежных средств прошло успешно. Комиссия за снятие наличных 600. Баланс {card.balance}.")
            card.count_of_operations += 1
            if card.count_of_operations % 3 == 0:
